...
from preprocessing import load_acm, sparse_to_tuple, preprocess_graph
...
dataset = "ACM"
print("ACM dataset")
adj, features, labels = load_acm('/home/mrabah_n/code/CVGAE/data/ACM')
nClusters = 3
...
y_pred, y = network.train(features, adj_norm, adj_label, adj, labels, weight_tensor_orig, norm, optimizer="Adam", epochs=400, lr=0.001, beta_1=0., beta_2=0.35, save_path=save_path, dataset=dataset)
