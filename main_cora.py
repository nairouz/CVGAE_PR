...
dataset = "Cora"
print("Cora dataset")
adj, features, labels = load_data('cora', '/home/mrabah_n/code/CVGAE/data/Cora')
nClusters = 7
...
#y_pred, y = network.pretrain(features, adj_norm, adj_label, labels, weight_tensor_orig, norm, optimizer="Adam", epochs=1000, lr=0.01, save_path=save_path, dataset=dataset)
y_pred, y = network.train(features, adj_norm, adj_label, adj, labels, weight_tensor_orig, norm, optimizer="Adam", epochs=1000, lr=0.001, beta_1=0., beta_2=0.25, save_path=save_path, dataset=dataset)
