...
import math
import itertools
from model_wiki import CVGAE
from preprocessing import load_data, mask_test_edges, sparse_to_tuple, preprocess_graph, load_wiki
...
def plot_confusion_matrix(cm, target_names, title='Confusion matrix', cmap=None, normalize=True):
    ...
    plt.savefig("/home/mrabah_n/code/CVGAE/results/Wiki/train/confusion_matrix.png")

# Dataset Name
dataset = "Wiki"
print("Wiki dataset")
adj, features, labels = load_wiki('/home/mrabah_n/code/CVGAE/data/Wiki')
nClusters = 17
...
#y_pred, y = network.pretrain(features, adj_norm, adj_label, labels, weight_tensor_orig, norm, optimizer="Adam", epochs=200, lr=0.01, save_path=save_path, dataset=dataset)
y_pred, y = network.train(features, adj_norm, adj_label, adj, labels, weight_tensor_orig, norm, optimizer="Adam", epochs=1000, lr=0.001, beta_1=0., beta_2=0.13, save_path=save_path, dataset=dataset)
